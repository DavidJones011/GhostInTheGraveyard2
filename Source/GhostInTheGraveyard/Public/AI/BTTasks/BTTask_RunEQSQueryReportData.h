...
#include "BTTask_RunEQSQueryReportData.generated.h"
 ...
 */
UCLASS()
class GHOSTINTHEGRAVEYARD_API UBTTask_RunEQSQueryReportData : public UBTTask_BlackboardBase
{
	...
	/** finish task */
	virtual void OnQueryFinished(TSharedPtr<FEnvQueryResult> Result);
